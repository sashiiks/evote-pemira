                            ...
                            @foreach ($data as $item)
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $item->visi }}</td>
                                        <td>{{ $item->misi }}</td>
                                        <td><img src="/kandidat/{{ $item->photo }}" width="50" height="auto"
                                                alt="jpeg" class="rounded-circle"></td>
                                        <td><a href="{{ url('/datacalon/edit', $item->id) }}"
                                                class="btn btn-warning">Edit</a></td>
                                        <td><a href="{{ url('/datacalon/del', $item->id) }}"
